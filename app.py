...
def search_by_salary():
    ...
    print(len(temp_path))
    if temp_path != '':
        return render_template('mysearchbysalpage.html', image_path=temp_path, message="Found Data!!")
    else:
        return render_template('mysearchbysalpage.html', error="Picture not found :(")
